...
- CA-03: Registrar el resultado del cruce (ganador, empate, método) completa el puntaje de ese criterio para los dos candidatos — **a confirmar con Marcos antes de asignar ticket**: ¿ganador = puntaje máximo del criterio y perdedor = 0, o el admin igual ajusta un puntaje dentro de un rango después de ver quién ganó?
