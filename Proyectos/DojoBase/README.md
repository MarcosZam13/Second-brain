...
- **Spike de Realtime** — es lo primero de todo. Ver [[Proyectos/CoreBase/realtime|realtime.md]]: en v1 nunca funcionó y la causa era estructural, así que hay que probarlo end-to-end antes de que sparring, notificaciones y proyección de torneos dependan de él.
