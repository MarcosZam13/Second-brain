...
> Propuesta de Marcos, aceptada el 2026-08-18 para destrabar el diseño de interfaz — sujeta a confirmación cuando el equipo completo la repase (mismo criterio que otras decisiones individuales de este documento, ver sección 7).
...
- **Visibilidad (decidido 2026-08-18):** un producto personalizado sigue el mismo patrón `owner_id` + `household_id` nullable que las listas (sección 4.1/4.2) — personal si el usuario no pertenece a household o no lo comparte explícitamente, visible para todo el household si sí. Mismo criterio aplicado a [[#4.11 Grupos de productos (aceptado 2026-08-18, sujeto a confirmación del equipo)|grupos de productos]] más abajo, para no mantener dos modelos de acceso distintos por una diferencia que no lo amerita.
...
### 4.11 Grupos de productos (aceptado 2026-08-18, sujeto a confirmación del equipo)

> Propuesta de Marcos, surgida después de la reunión de equipo del 2026-08-16 — aceptada el 2026-08-18 para poder generar la interfaz en [[Proyectos/Tacha/DESIGN|DESIGN.md]] sin dejar huecos, sujeta a confirmación cuando el equipo completo la repase (mismo criterio que otras decisiones individuales de este documento, sección 7).
...
| `product_groups` | **Nueva (aceptado 2026-08-18):** grupo nombrado de productos frecuentes (ej. "Mercado quincenal"). Mismo patrón de dueño que `lists`: `owner_id` siempre presente, `household_id` nullable — personal por defecto, compartido con el household si el usuario lo asocia. Ver [[#4.11 Grupos de productos (aceptado 2026-08-18, sujeto a confirmación del equipo)|4.11]] |
| `product_group_items` | **Nueva (aceptado 2026-08-18):** producto dentro de un grupo, referenciando una `product_catalog_variants` con su cantidad por defecto — mismo rol que `recipe_ingredients` pero sin porciones ni multiplicador |
