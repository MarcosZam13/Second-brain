...
- [[Proyectos/Tacha/jira-plan|jira-plan.md]] — plan de nivel épica en Jira (22 épicas SCRUM-1 a SCRUM-22, proyecto "Equipo Dinamita"), recorte de alcance por prioridad Highest/Low; el plan real de sprints semana a semana sigue viviendo en `analisis-complejidad-viabilidad.md`, no acá.
...
- `mockups/mockup-web-v3.html` — mockup HTML guía (2026-09-06) con las 9 pantallas de prioridad Alta de DESIGN.md (landing, onboarding, catálogo + detalle, mis productos, "¿qué hiciste?", edición rápida pre/post-compra, mis grupos, lista general), ya con el sidebar de 6 ítems y sub-tabs reales, para que el equipo tenga una referencia visual única antes de generar en Stitch. `mockup-web-v2.html` queda como versión anterior — su navegación y componentes no reflejan las decisiones de DESIGN.md (sidebar viejo con "Historial" suelto, sin Catálogo/sub-tabs, sin los componentes nuevos de grupos/inventario), solo sirve de referencia histórica de tokens de color.
