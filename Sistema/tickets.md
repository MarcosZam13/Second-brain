...
| QA | Aseguramiento de la Calidad del Software | QA-31 | QA-32 |
...
| MB | MemberBase (plataforma/CoreBase, trabajo transversal del monorepo) | MB-1 | MB-2 |
| DOJO | DojoBase | — | DOJO-1 |
| GYM | GymBase | — | GYM-1 |
...
|---|---|---|---|
| VAULT | Cambios al propio sistema del vault (skills, agentes, CLAUDE.md, estructura) | VAULT-30 | VAULT-31 |
