...
| 2026-10-01 (semana 9) | [[Cursos/SistemasOperativos/apuntes/proyecto-programado-1-plataforma-multimedia\|I Proyecto Programado]] — plataforma distribuida de procesamiento multimedia por casos (v2.0) | parte del 30% | **Rol A hecho y probado (2026-09-17); repo pusheado a GitHub (`MarcosZam13/plataforma-multimedia`) con proceso de equipo completo — CLAUDE.md, ARCHITECTURE/SCRUM/USER_STORIES, GITFLOW, 2 skills y 3 subagentes propios del proyecto (2026-09-18).** Falta invitar a Mario y Joseph. Rol B (Mario, ffmpeg real) y Rol C (Joseph, Tailscale + dashboard + dataset) sin empezar |
