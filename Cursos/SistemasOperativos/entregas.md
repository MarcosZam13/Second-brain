...
| 2026-10-01 (semana 9) | [[Cursos/SistemasOperativos/apuntes/proyecto-programado-1-plataforma-multimedia\|I Proyecto Programado]] — plataforma distribuida de procesamiento multimedia por casos (v2.0) | parte del 30% | **Rol A (coordinador + modelo de casos + chord de cierre) hecho y probado en una máquina, 2026-09-17.** Repo local en `C:\Users\luisy\Documents\Uni\SO\plataforma-multimedia` (sin remoto en GitHub todavía). Faltan Rol B (Mario, procesamiento real con ffmpeg) y Rol C (Joseph, Tailscale multi-máquina + dashboard + dataset) — ver README del repo |
