...
fuente:
  ...
  - _fuentes/Estadistica_guia-unidad2-resuelta-semana4_2026-09-01.pdf
...
Ver también: [[Cursos/Estadistica/temario]] · [[Cursos/Estadistica/entregas]] · [[Cursos/Estadistica/repasos/quiz-1-semanas-1-2|Repaso para Quiz 1 (semanas 1-2)]] · [[Cursos/Estadistica/repasos/quiz-2-semanas-3-4|Repaso para Quiz 2 (semanas 3-4)]]

> Guía del profesor Elvis Mejías Ramírez (MA-3405, II Semestre 2026). Cubre la Unidad 1 (Introducción a la Inferencia Estadística) y la Unidad 2 (Estimación para una Población). El archivo `Estadistica_guia-unidad1-resuelta-semana1_2026-08-07.pdf` es la misma guía de Unidad 1 trabajada en la sesión de Semana 1, con las respuestas propias a los ejercicios de práctica ya resueltas a mano. `Estadistica_guia-unidad2-resuelta-semana2_2026-08-18.pdf` es el mismo tipo de material pero de Semana 2: cierre de los ejercicios de máxima verosimilitud (problemas 8-17) y arranque de la Unidad 2 con la sección 2.1.1 (intervalos de confianza para una media), con 14 ejercicios de práctica resueltos a mano. `Estadistica_guia-unidad2-resuelta-semana3_2026-08-21.pdf` continúa la Unidad 2 en Semana 3: sección 2.1.2 (IC para una proporción, 10 ejercicios resueltos) y 2.1.3 (IC para una varianza, 10 ejercicios resueltos). `Estadistica_guia-unidad2-resuelta-semana4_2026-09-01.pdf` cierra la Unidad 2 en Semana 4: sección 2.2 (pruebas de hipótesis para media, proporción y varianza) — teoría completa (hipótesis nula/alternativa, errores tipo I/II, potencia, los dos enfoques de decisión) más 8 ejercicios resueltos a mano, todos sobre pruebas para una media. Ninguno se transcribe acá, quedan en sus fuentes archivadas — el resumen accionable está en los repasos enlazados arriba (Quiz 1 = semanas 1-2; Quiz 2 = semanas 3-4, ver [[Cursos/Estadistica/entregas]]).
...
**Semana 4 (pruebas de hipótesis para una media, resueltos a mano):** 8 ejercicios — plantear $H_0$/$H_1$ a partir de una afirmación en palabras (problema 1, con 6 situaciones distintas de media/proporción/varianza), redactar regiones de aceptación/rechazo y las probabilidades de error tipo I/II para una $H_1'$ específica (problema 2, un caso de media/proporción/varianza cada uno), y luego 8 problemas completos de prueba de hipótesis para la media con enfoque clásico (regiones + valor crítico $\mu_c$), incluyendo un caso de potencia de la prueba (problema 6) y dos de "trabajar al revés" (dado $\mu_c$ o la región, hallar el nivel de significancia usado — problemas 8). Quedan completos en `_fuentes/Estadistica_guia-unidad2-resuelta-semana4_2026-09-01.pdf`.
